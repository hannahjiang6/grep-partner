 ...
 *             the string contents).
 *           - Because std::hash is a struct/class, you must make an
 ...
 *               "(key)" after the object --- this causes C++ to use
 ...
 *             variable, function, etc.). Don't name anything in your
 *             program "hash" when using this facility.
 *
